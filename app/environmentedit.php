...
?>
    ...
    <div id="content" class="container">
        ...
        <form method="post" action="relationcreate.php" id="form-edit">
            ...
            <div class="form_container">
                <div class="form_block form_full_length">
                    <label>
                        Omgevingsnaam<br>
                        <input id="test_environment_name" name="environment_name" type="text" minlength="2"
                               maxlength="45" onkeydown="setTimeout(error_environment_name, 1500)"
                               value="<?= $environment->get_environment_name(); ?>" required/>
                    </label>
                    <br>
                ...
                <div class="form_block form_full_length">
                    ...
                    <select name="customer_id" id="customer" required>
                        ...
                        foreach ($customerlist as $customer) : ?>
                            ...
                            <option <?php if ($environment->get_customer_id() == $customer->get_customer_id()) {
                                echo "selected";
                            } ?> value="<?= $customer->get_customer_id() ?>"><?= $customer->get_customer_name() ?></option>
                            ...
                            <div class="form_block">
                                ...
                                <div class="form_block">
                                    ...
                                    <select name="vm_name_from[]" id="vm_name_from" required>
                                        <option value="<?= $relation_array[$x]->get_vm_name_from(); ?>"
                                                selected><?= $relation_array[$x]->get_vm_name_from(); ?></option>
                                ...
                                <div class="form_block">
                                    ...
                                    <select name="vm_name_to[]" id="vm_name_to" required>
                                        <option value="<?= $relation_array[$x]->get_vm_name_to(); ?>"
                                                selected><?= $relation_array[$x]->get_vm_name_to(); ?></option>
                                        <?php foreach (get_sorted_virtualmachine_list() as $vm) : ?>
                                            <option value="<?= $vm->getName(); ?>"><?= $vm->getName(); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form_block form_full_length">
                                    <label> Omschrijving<br>
                                        <textarea id="test_description" rows="5" cols="50" name="relation_description[]"
                                                  onkeydown="setTimeout(error_description, 1500)"><?= $relation_array[$x]->get_description(); ?></textarea>
                                ...
                                <input id='del-relationship-btn' type='button' value='Verwijder deze relatie'
        ...
        <div class="buttons_bottom">
            ...
            <button class="btn-user-delete" id="show_modal"
                    onclick="show_modal('<?= $environment->get_environment_name(); ?>', 'form-delete')"
                    value="delete-environment">Omgeving verwijderen
            </button>
